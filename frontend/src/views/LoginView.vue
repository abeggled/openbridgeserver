  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-950">
    <div class="w-80 bg-gray-900 border border-gray-700 rounded-2xl p-8 shadow-2xl">
      ...
      <div class="text-center mb-8">
        <div class="text-3xl font-bold text-blue-400 mb-1">openTWS</div>
        <div class="text-sm text-gray-500">Visualisierung · Anmeldung</div>
      </div>
      ...
      <form @submit.prevent="login" class="space-y-4">
        <div>
          ...
          <input
            ...
            autofocus
            class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-gray-100 focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>
        <div>
