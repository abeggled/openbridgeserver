...
const NODE_DEFS = computed(() => ({
  ...
  value_sequence: { label: t('logic.nodeTypes.value_sequence'), color: '#b45309', inputs: [{id:'trigger',label:t('logic.ports.trigger')},{id:'condition',label:t('logic.ports.condition')}], outputs: [{id:'running',label:t('logic.ports.running')},{id:'done',label:t('logic.ports.done')},{id:'cancelled',label:t('logic.ports.cancelled')}] },
