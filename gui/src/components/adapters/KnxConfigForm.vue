            ...
            <div class="flex flex-col gap-2">
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-2 text-sm flex-1">
                  <span><span class="text-slate-400">{{ $t('adapters.knx.keyfile.physAddrCol') }} </span>{{ t.individual_address }}</span>
                  <span><span class="text-slate-400">{{ $t('adapters.knx.keyfile.userIdCol') }} </span>{{ t.user_id }}</span>
                  <span><span class="text-slate-400">{{ $t('adapters.knx.keyfile.secureGAsCol') }} </span>{{ t.secure_ga_count }}</span>
                </div>
              </label>
            </div>
          </div>
