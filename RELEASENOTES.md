...
* Monitor/RingBuffer: Empty hierarchy filters now match no entries instead of widening the query to unrelated events. The legacy migration assistant now excludes safely reclaimable stale copy-phase chunks from its copy estimate and effective free-space calculation while preserving recoverable chunks from interrupted commit windows. https://github.com/abeggled/openbridgeserver/issues/1009 https://github.com/abeggled/openbridgeserver/issues/1061
