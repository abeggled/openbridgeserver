...
* Monitor/RingBuffer: Empty hierarchy filters now match no entries instead of widening the query to unrelated events. The legacy migration assistant now excludes safely reclaimable stale copy-phase chunks from its copy estimate and effective free-space calculation, preserves all chunks while a migration or interrupted-commit recovery is active, and credits free disk only for files that actually exist. https://github.com/abeggled/openbridgeserver/issues/1009 https://github.com/abeggled/openbridgeserver/issues/1061
