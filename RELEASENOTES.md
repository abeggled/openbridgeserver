...
* Logic Engine: Read Object blocks now load the current object value when a logic sheet is saved, activated, imported, or duplicated, so downstream logic starts with the latest known state immediately instead of waiting for the next object update. https://github.com/abeggled/openbridgeserver/issues/1031
