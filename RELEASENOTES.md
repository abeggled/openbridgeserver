...
* Security: Preserve legacy `OPENTWS_*`/`OPENTWS_CONFIG` compatibility and fallback to `opentws.db` on upgrades to avoid unintended default-admin re-bootstrap. https://github.com/abeggled/openbridgeserver/pull/554
