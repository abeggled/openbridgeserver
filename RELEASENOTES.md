...
### New features ✨
* Backend/Admin GUI (Upstream PR #PENDING): Added owner-first role-scope editing with atomic audited grant persistence, effective permission previews, and conflict-safe ETag updates.
