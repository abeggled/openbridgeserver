...
### New features ✨
* Backend/Admin GUI (Upstream PR #PENDING): Added secure explicit first-owner bootstrap and offline recovery, atomic user-artifact transfer and API-key revocation during account deletion, and narrowly scoped admin-approved API-key capabilities for Visu page and datapoint metadata configuration.
