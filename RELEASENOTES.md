...
### New features ✨
* Backend/Admin GUI (Upstream PR #PENDING): Added fail-closed Logic graph and side-effect capabilities, adapter delegation declarations, audited user/settings mutations, and server-backed action preflight before delegated graph runs.
