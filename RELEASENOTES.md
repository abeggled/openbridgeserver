...
* Security: Restore public/protected viewer bootstrap reads and WebSocket connectivity without forcing JWT, while keeping page-scoped datapoint access checks for anonymous sessions. https://github.com/abeggled/openbridgeserver/pull/553
