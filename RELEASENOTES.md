...
* Security: Harden SVG icon import sanitization (obfuscated javascript href, deep nesting guard, stable `<svg>` serialization), make ZIP imports atomic on sanitize errors, and preserve API-key admin flows across username changes. https://github.com/abeggled/openbridgeserver/pull/555
