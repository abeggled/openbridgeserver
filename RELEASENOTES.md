...
* Logic Security: Pushover notification nodes can now read the app token and user key from secret files by safe file name, matching the configured OBS secret directory and rejecting path traversal.
