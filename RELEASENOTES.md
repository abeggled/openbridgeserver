...
* Logicmodule Security (Upstream PR #PENDING): prevent SSRF/data exfiltration in iCal URL fetching by enforcing public-network URL validation and streamed size limits.
